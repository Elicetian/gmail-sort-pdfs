...
- darnetal_gestion : appels de fonds / relevés mensuels pour un appartement à Darnetal (Citya ou FONCIA Normandie)
- desnouettes_appel_fonds : appels de fonds trimestriels d'une copropriété rue Desnouettes (syndic Citya Bonnefoi)
- desnouettes_gestion : comptes rendus de gestion mensuels de la copropriété Desnouettes (Citya Bonnefoi)
- desnouettes_ag : convocations et PV d'assemblée générale de la copropriété Desnouettes
- darnetal_ag : convocations et PV d'assemblée générale de la copropriété Darnetal
- darnetal_travaux : factures et devis de travaux pour l'appartement Darnetal
- desnouettes_travaux : factures et devis de travaux pour la copropriété Desnouettes
- darnetal_conseil_syndical : documents du conseil syndical de Darnetal
- desnouettes_conseil_syndical : documents du conseil syndical de la copropriété Desnouettes
- darnetal_tenant : documents relatifs au locataire (bail, état des lieux, quittances...)
- darnetal_fiscal : documents fiscaux annuels de l'appartement Darnetal (aide à la déclaration des revenus fonciers, bilan annuel des charges, récapitulatif fiscal)
...
- darnetal_fiscal        → YYYY_aide-declaration-revenus-fonciers.pdf  ou  YYYY-bilan-charges-[periode].pdf
