...
_DRIVE_FOLDERS_JSON = json.dumps({k: "test_id" for k in [
    "factures", "parking", "darnetal_gestion", "desnouettes_appel_fonds",
    "desnouettes_gestion", "desnouettes_ag", "darnetal_ag", "darnetal_travaux",
    "desnouettes_travaux", "darnetal_conseil_syndical", "desnouettes_conseil_syndical",
    "darnetal_tenant", "darnetal_fiscal",
]})
